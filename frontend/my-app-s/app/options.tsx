      ...
      <View style={styles.content}>
        ...
        <View style={styles.gridContainer}>
          ...
          >
            ...
            <Text style={styles.boxText}>Caption Generator</Text>
          </TouchableOpacity>
        ...
        >
          <View style={styles.modalContent}>
            ...
            <Text style={styles.modalText}>
              ...
              {'\n\n'}3️⃣ Caption Generator: Extract audio generate & download captions 
              {'\n\n'}4️⃣ Translation: Get audio translations between supported languages
            </Text>
            <Pressable
